...
recognition.onspeechend = function() {
  instructions.text('请检查是否成功挂载VPN，连接外网。长时间未说话，已自动关闭录音。');
}
...
function renderNotes(notes) {
  ...
  if(notes.length) {
    notes.forEach(function(note) {
      html+= `<li class="note">
        <p class="header">
          ...
          <a href="#" class="listen-note" title="Listen to Note">读出内容</a>
    ...
    html = '<li><p class="content">暂无记录</p></li>';
  }
  notesList.html(html);
}
